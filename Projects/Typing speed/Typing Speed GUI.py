...
class Game:
    ...
    def __init__(self):
        ...
        pygame.init()
        self.open_img = pygame.image.load(r"D:\Programming Project\Python Project\Typing Speed\Imegas\background.jpg")
        self.open_img = pygame.transform.scale(self.open_img, (self.w, self.h))

        self.bg = pygame.image.load(r"D:\Programming Project\Python Project\Typing Speed\Imegas\type.jpg")
    ...
    def show_results(self, screen):
        if(not self.end):
            ...
            # draw icon image
            self.time_img = pygame.image.load(r"D:\Programming Project\Python Project\Typing Speed\Imegas\icon.png")
